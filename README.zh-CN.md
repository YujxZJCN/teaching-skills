...
14 个技能 · 78 种模式 · 67 个智能体协同 · 2 道质量门控 · 1 份课程护照（Course Passport）
...
完整的首次使用示例见 [QUICKSTART.md](QUICKSTART.md)，全部 78 种模式见
...
5. **以设计保障诚信，而非依赖检测。** AI 时代学术诚信模型
   ...
   模式。本套件不依赖任何 AI 检测工具。
6. **诚实地解读证据。** 学生评教被视为带有偏差的小样本证据，反映的是学生体验
